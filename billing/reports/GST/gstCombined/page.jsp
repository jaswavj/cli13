...
<div class="container mt-5">
    <h2 class="text-center mb-4">GST Combined Report (Sales &amp; Purchase)</h2>
    <form action="<%=contextPath%>/reports/GST/gstCombined/page1.jsp" method="get" class="row g-3 mb-4">
        <div class="col-md-4">
